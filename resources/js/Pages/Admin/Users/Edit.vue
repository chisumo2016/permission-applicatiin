...
<!--                                route('roles.permissions.destroy',[user.id,  userRole.id])-->
                                <Link
                                    :href="route('users.roles.destroy',[user.id,  userRole.id])"
                                    method="DELETE"
                                    as="button"
                                    class="text-red-400 hover:text-red-600" preserve-scroll>Revoke</Link>
                            </TableDataCell>
                        </TableRow>
                    </template>
                </Table>
                ...
                <Table>
                    ...
                    <template #default>
                        <TableRow v-for="userPermission in user.permissions" :key="userPermission.id" class="border-b">
                            ...
                            <TableDataCell class="space-x-4">
<!--                                :href="route('roles.permissions.destroy',[user.id,  userPermission.id])"-->
                                <Link
